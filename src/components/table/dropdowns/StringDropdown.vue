...
import { FILTER_STRING_RULES, FILTER_STRING_RULES_WITH_EMPTY } from '@/constants/filterRules'
...
const filterList = computed(() => (props.keysForFilterStringEmpty.includes(props.filter.key) ? FILTER_STRING_RULES_WITH_EMPTY : FILTER_STRING_RULES))
